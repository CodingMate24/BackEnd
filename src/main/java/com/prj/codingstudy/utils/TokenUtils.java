package com.prj.codingstudy.utils;

import com.prj.codingstudy.config.model.UserDto;
import com.prj.codingstudy.config.model.ValidTokenDto;
...
public class TokenUtils {
     ...
     */
    public static Date createExpiredDate(boolean isAccessToken) {
    ...
    private static Map<String, Object> createClaims(UserDto userDto, boolean isAccessToken) {
        ...
        claims.put("userId", userDto.getMbrEmail());
        if (isAccessToken) {
            claims.put("userNm", userDto.getMbrEmail());
        }
        return claims;
    }
    ...
    public static String generateJwt(UserDto userDto) {
        ...
        JwtBuilder builder = Jwts.builder()
                ...
                .subject(String.valueOf(userDto.getMbrId()))           // Payload - Subject 구성
     ...
     * @return
     */
    public static String generateRefreshToken(UserDto userDto, Date expiredTime) {
        return Jwts.builder()
            .setHeader(createHeader())
            .claims(createClaims(userDto, false))
            .subject(String.valueOf(userDto.getMbrId()))
    ...
    public static UserDto getClaimsToUserDto(String token, boolean isAccessToken) {
        ...
        if (isAccessToken) {
            ...
            return UserDto.builder().mbrEmail(userId).mbrNickname(userNm).build();
        } else {
            return UserDto.builder().mbrEmail(userId).build();
        }
    }
}
