...
import com.prj.codingstudy.config.filter.CustomAuthenticationFilter;
import com.prj.codingstudy.config.filter.JwtAuthorizationFilter;
import com.prj.codingstudy.config.handler.CustomAuthFailureHandler;
import com.prj.codingstudy.config.handler.CustomAuthSuccessHandler;
import com.prj.codingstudy.config.handler.CustomAuthenticationProvider;
import com.prj.codingstudy.config.handler.CustomLogoutHandler;
...
public class SecurityConfig {
    ...
    public CustomAuthenticationFilter customAuthenticationFilter() {
        ...
        customAuthenticationFilter.setFilterProcessesUrl("/api/login");     // 접근 URL
    ...
    public AuthenticationSuccessHandler customLoginSuccessHandler() {
        return new CustomAuthSuccessHandler(authAccessLogService);
    }
